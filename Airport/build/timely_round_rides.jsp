...
<html>
	...
	<body>
		...
		<div class="content">
			<%
				String one_date = request.getParameter("flex-trip-date"); 
				LocalDate originalDate = LocalDate.parse(one_date);
				...
				ResultSet t = st.executeQuery("SELECT * FROM Flights WHERE DATE(DepartTime) BETWEEN '"+ startDate +"' AND '"+ endDate +"'" );
