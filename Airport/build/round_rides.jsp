...
<html>
	...
	<body>
		...
		<div class="content">
			<%
				String one_date = request.getParameter("round-trip-date"); 
				...
				ResultSet t = st.executeQuery("SELECT * FROM Flights WHERE TripType='Round Trip' AND DATE(DepartTime)='"+ one_date +"'");
