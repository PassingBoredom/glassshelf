...
<html>
	...
	<body>
		...
		<div class="fixed-sidebar">
			<table>
				...
				<tr>
					...
					<td><input type="submit" value="Flex Round-Trip Flights" class="btn"/></td>
		...
		<div class="content">
			<%
				String depart = request.getParameter("depart-port");
				String arrive = request.getParameter("arrive-port");
				...
				ResultSet t = st.executeQuery("SELECT * FROM Flights WHERE DepartLocation='"+ depart +"' AND ArrivalLocation='"+ arrive +"'");
